namespace SuperMarketScraper
{
    partial class Form1
    {
		...
		private void InitializeComponent()
		{
			...
			tabPage1.Size = new Size(888, 356);
			tabPage1.TabIndex = 0;
			...
			tabPage2.Size = new Size(888, 358);
			tabPage2.TabIndex = 1;
			tabPage2.Text = "ΑΒ";
			...
			tabPage3.Size = new Size(888, 358);
			tabPage3.TabIndex = 2;
			...
			tabPage4.Size = new Size(888, 358);
			tabPage4.TabIndex = 3;
			...
			label2.Location = new Point(18, 344);
			...
			checkBoxSklavenitis.Location = new Point(246, 344);
			checkBoxSklavenitis.Name = "checkBoxSklavenitis";
			checkBoxSklavenitis.Size = new Size(104, 23);
			...
			checkBoxAB.Location = new Point(364, 344);
			checkBoxAB.Name = "checkBoxAB";
			checkBoxAB.Size = new Size(45, 23);
			...
			checkBoxMarket.Location = new Point(430, 344);
			checkBoxMarket.Name = "checkBoxMarket";
			checkBoxMarket.Size = new Size(96, 23);
			...
			checkBoxMasoutis.Location = new Point(542, 344);
			checkBoxMasoutis.Name = "checkBoxMasoutis";
			checkBoxMasoutis.Size = new Size(95, 23);
			...
			// searchbtn
			// 
			searchbtn.Location = new Point(14, 384);
			...
			// 
			mymrk.AutoSize = true;
			mymrk.Font = new Font("Segoe UI", 12F);
			mymrk.Location = new Point(38, 198);
			mymrk.Name = "mymrk";
			mymrk.Size = new Size(92, 21);
			mymrk.TabIndex = 2;
			...
			// 
			ab.AutoSize = true;
			ab.Font = new Font("Segoe UI", 12F);
			ab.Location = new Point(38, 115);
			ab.Name = "ab";
			ab.Size = new Size(36, 21);
			ab.TabIndex = 1;
			ab.Text = "ΑΒ: ";
			// 
			// skl
			// 
			skl.AutoSize = true;
			skl.Font = new Font("Segoe UI", 12F);
			skl.Location = new Point(38, 46);
			skl.Name = "skl";
			skl.Size = new Size(103, 21);
			skl.TabIndex = 0;
			skl.Text = "Σκλαβενίτης: ";
			// 
			// Cancel
			// 
			Cancel.Location = new Point(188, 384);
			Cancel.Name = "Cancel";
			...
			// delete_btn
			// 
			delete_btn.Location = new Point(364, 384);
			...
			saveCombo_box.Size = new Size(177, 25);
			...
			loadCombo_box.Size = new Size(177, 25);
			...
			excel_btn.Font = new Font("Segoe UI", 11F);
			excel_btn.Image = (Image)resources.GetObject("excel_btn.Image");
			excel_btn.Location = new Point(1162, 347);
